...
namespace DigitalRubyShared
{
    ...
    public class FingersScript : MonoBehaviour
    {
        ...
        private void PopulateGameObjectsForTouch(int pointerId, float x, float y)
        {
            ...
            int hackCount = Physics2D.OverlapPoint(p.position, ContactFilter2D.noFilter, hackResults);
        ...
        private void OnEnable()
        {
            ...
            if (EventSystem.current == null && AutoAddRequiredComponents && FindFirstObjectByType<EventSystem>() == null)
            {
